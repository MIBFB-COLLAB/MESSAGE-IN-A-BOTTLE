...
describe('Create new story', () => {
  ...
  it('Should be able click submit story button, in order to submit new story', () => {
    ...
    .get('div')
    .get('#newStoryModal')
    .get('.title').type('Story')
    cy.get('[id="message"]').type('Paleo tacos cliche DIY, dreamcatcher trust fund iPhone taxidermy hammock chillwave bespoke artisan sustainable.')
